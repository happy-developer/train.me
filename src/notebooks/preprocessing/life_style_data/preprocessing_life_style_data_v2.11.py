...
selected_features = [
    ...
    # "Age", "Weight (kg)", "Gender", "Experience_Level", "Workout_Frequency (days/week)", "Session_Duration (hours)", "Height (m)", "Max_BPM", "Avg_BPM", "Resting_BPM", "Difficulty Level", "Body Part"
]
...
feature_cols_raw = [
    ...
    "Gender_1.0",
    "Experience_Level",
    "Difficulty Level",                 # 🔹 nouvelle feature numérique (0/1/2)
...
feature_schema = {
    ...
    "model_version": "v2.11-minimal",  # ajuste si tu es sur un set élargi
    "created_at": datetime.utcnow().isoformat() + "Z",
