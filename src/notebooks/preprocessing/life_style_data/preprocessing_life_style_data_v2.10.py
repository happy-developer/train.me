...
selected_features = [
    ...
    # "Age", "Weight (kg)", "Gender", "Experience_Level", "Workout_Frequency (days/week)", "Session_Duration (hours)", "Height (m)", "Max_BPM", "Avg_BPM", "Resting_BPM"
]
...
feature_schema = {
    ...
    "model_version": "v2.10-minimal",  # ajuste si tu es sur un set élargi
    "created_at": datetime.utcnow().isoformat() + "Z",
