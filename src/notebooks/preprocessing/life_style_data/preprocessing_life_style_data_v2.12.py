...
selected_features = [
    ...
    # "Age", "Weight (kg)", "Gender", "Experience_Level", "Workout_Frequency (days/week)", "Session_Duration (hours)", "Height (m)", "Max_BPM", "Avg_BPM", "Resting_BPM", "Difficulty Level", "Body Part", "Equipment Needed"
]
...
manual_specs = {
    ...
    "Body Part": {                    
     ...
     "Equipment Needed": {                     # 🆕 nouveau champ
        "type": "string",
        "enum": [
            "Step or Box",
...
feature_schema = {
    ...
    "model_version": "v2.12-minimal",  # ajuste si tu es sur un set élargi
    "created_at": datetime.utcnow().isoformat() + "Z",
