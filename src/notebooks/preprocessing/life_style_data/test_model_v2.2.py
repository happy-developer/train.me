...
ui_input = {
    ...
    # Champs actuellement désactivés dans le modèle v1 :
    "Gender": "Male",               # Sexe de l'utilisateur (sera activé dans v2)
    "Experience_Level": 2.0 # Valeur numérique telle que présente dans le dataset
    # "Difficulty Level": "Easy",     # Difficulté de la séance choisie
}
...
def ui_to_internal_row(ui_dict: dict, expected_cols: list[str]) -> pd.DataFrame:
    ...
    Experience_Level numérique) en DataFrame aligné sur les colonnes internes
    attendues par le modèle (Age, Weight (kg), Gender_1.0, Experience_Level).
    """
    row = {}
...
# %%
batch_ui = [
    {"Age": 34, "Weight (kg)": 115.0, "Gender": "Male",   "Experience_Level": 1.98},
    {"Age": 52, "Weight (kg)": 60.0,  "Gender": "Female", "Experience_Level": 2.01},
]
