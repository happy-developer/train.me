...
selected_features = [
    ...
    # "Age", "Weight (kg)", "Gender", "Experience_Level", "Workout_Frequency (days/week)", "Session_Duration (hours)", "Height (m)", "Max_BPM", "Avg_BPM", "Resting_BPM", "Difficulty Level", "Body Part", "Equipment Needed", "Water_Intake (liters)", "Fat_Percentage"
]
...
feature_schema = {
    ...
    "model_version": "v2.14-minimal",  # ajuste si tu es sur un set élargi
    "created_at": datetime.utcnow().isoformat() + "Z",
