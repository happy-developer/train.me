...
# # Filtrer uniquement les features "métier" retenues, soustrait des colonnes de la feature selection
# selected_features = [
#     # Prédiction target
#     "Calories_Burned",
...
plt.title("Corrélation des 50 variables les plus liées à Calories_Burned")
...
top_importances = importances.head(50)

plt.figure(figsize=(8,4))
top_importances.plot(kind="bar", color="orange")
plt.title("Top 50 - Importance des variables (RandomForest)")
...
feature_schema = {
    ...
    "model_version": "v2.16-minimal",  # ajuste si tu es sur un set élargi
    "created_at": datetime.utcnow().isoformat() + "Z",
